...
if ($_GET) {
    if (isset($_GET['subcategory'])) {
        ...
        if ($subcategory->getSubcategoryId()->num_rows == 1) {
            $productModel->setSubcategory_id($_GET['subcategory']);
            $productResult = $productModel->getProductsBySubcategory()->fetch_all(MYSQLI_ASSOC);
        } else {
        ...
        if ($category->getcategoryId()->num_rows == 1) {
            $productModel->setCategory_id($_GET['category']);
            $productResult = $productModel->getProductsBycategory()->fetch_all(MYSQLI_ASSOC);
        } else {
            header('location:error/404.php');
            die;
        }
        ...
        if ($brand->getBrandId()->num_rows == 1) {
            $productModel->setBrand_id($_GET['brand']);
            $productResult = $productModel->getProductsByBrand()->fetch_all(MYSQLI_ASSOC);
        } else {
            header('location:error/404.php');
            die;
        }
    ...
    $productResult = $productModel->getAll()->fetch_all(MYSQLI_ASSOC);
}
