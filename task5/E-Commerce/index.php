...
$brands = new brand;
$brandsResult = $brands->getAll()->fetch_all(MYSQLI_ASSOC);
$products = new product;
$productsResult = $products->getRecentProduct();
$ordersResult = $products->mostSellingProducts();
?>
<!-- Slider Start -->
                ...
                <div class="product-wrapper col-3">
                    <div class="product-img">
                        <a href="shop.php?brand=<?= $brand['id'] ?>">
                            <img alt="" src="assets/img/brand/<?= $brand['image'] ?>">
                        </a>
                    ...
                    <div class="product-content text-left">
                        <div class="product-hover-style">
                            <div class="product-title">
                                <h4>
                                    <a href="product-details.php"><?= $brand['name_en'] ?></a>
                                </h4>
                            </div>
                        </div>
...
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
            ...
            <div class="tab-pane active">
                <div>
                    <div style='display:flex; justify-content:space-between'>
                        <?php if ($ordersResult->num_rows >= 1) { ?>
                            <?php

                            foreach ($productsResult->fetch_all(MYSQLI_ASSOC) as $product) { ?>

                                <div class="product-wrapper mb-30 " style='width:23%;'>
                                    <div class="product-img">
                                        <a href="product-details.php?product=<?= $product['id'] ?>">
                                            <img alt="" style='width:23%px;height:300px' src="assets/img/product/<?= $product['image'] ?>">
                                        </a>
                                        <span>-60%</span>
                                        <div class="product-action">
                                            <a class="action-wishlist" href="#" title="Wishlist">
        ...
        <div class="section-title-wrap text-center">
            <h3 class="section-title">Most Selling Products</h3>
        </div>

        <div class="tab-content jump mt-4">
            <div class="tab-pane active">
                <div>
                    <div style='display:flex; justify-content:space-between'>
                        ...
                        <?php if ($ordersResult->num_rows >= 1) { ?>
                            ...
                            <?php foreach ($ordersResult->fetch_all(MYSQLI_ASSOC) as $order) { ?>

                                <div class="product-wrapper mb-30 " style='width:23%;'>
                                    <div class="product-img">
                                        <a href="product-details.php?product=<?= $order['id'] ?>">
                                            <img alt="" style='width:23%px;height:300px' src="assets/img/product/<?= $order['image'] ?>">
                                        </a>
                                        <span>-60%</span>
                                        <div class="product-action">
                                            <a class="action-wishlist" href="#" title="Wishlist">
                                    ...
                                    <div class="product-content text-left">
                                        <div class="product-hover-style">
                                            <div class="product-title">
                                                <h4>
                                                    <a href="product-details.php"><?= $order['name_en'] ?></a>
                                                </h4>
                                            </div>
                                            <div class="cart-hover">
                                                <h4><a href="product-details.php">+ Add to cart</a></h4>
