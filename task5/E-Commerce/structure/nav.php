 ...
 <?php
    ...
    $categoryResult = $category->getAll()->fetch_all(MYSQLI_ASSOC);
                                     ...
                                     <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                         <ul class="mega-menu">
                                             ...
                                             <?php foreach ($categoryResult as $category) {
                                                    ...
                                                    $subcategoryName = $subcategory->getSubcategoryByCategoryId()->fetch_all(MYSQLI_ASSOC);
                                                ?>
                                                 <li>
                                                     <ul>
                                                         ...
                                                         <?php foreach ($subcategoryName as $subcategoryResult) { ?>

                                                             <li><a href="shop.php?subcategory=<?=$subcategoryResult['id']?>"><?= $subcategoryResult['name_en'] ?></a></li>
