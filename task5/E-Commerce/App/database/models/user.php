...
class user extends model
{
    ...
    private $id, $first_name, $last_name, $email, $phone, $password, $gender, $image, $verification_code, $status, $email_verified_at, $created_at, $updated_at;
    ...
    VALUES (?,?,?,?,?,?,?)";
        $stat = $this->conn->prepare($query); //return object or false
        if ($stat == false) {
            return $stat;
        }
        $stat->bind_param(
    ...
    {  //return false or object 
        ...
        $stat->bind_param('si', $this->email, $this->verification_code);
        $stat->execute();
    ...
    public function verify()
    {
        ...
        $stat->bind_param('ss', $this->email_verified_at, $this->email);
        return $stat->execute();
    }
    ...
    public function  updateVerificationCode()
    {
        ...
        $stat->bind_param('is', $this->verification_code, $this->email);
        return $stat->execute();
    }
    ...
    public function  updatePassword()
    {
        ...
        $stat->bind_param('ss', $this->password, $this->email);
        return $stat->execute();
    }
    ...
    public function  updateProfile()
    {
        ...
        $stat->bind_param('ssss', $this->first_name, $this->last_name, $this->gender, $this->email);
        return $stat->execute();
    }
