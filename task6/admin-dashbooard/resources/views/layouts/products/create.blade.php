...
@endif
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('dashboard.products.store') }}" method="post" class="mt-5 "
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" name="status"id="status">
                                    <option></option>
                                    <option @selected(old('status') === 1)value="1">Available</option>
                                    <option @selected(old('status') === 0)value="0">Not available</option>
                                </select>
                                @error('status')
                                    <div class="alert alert-white text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" name="subcategory_id"
                                    id="subcategory_id">

                                    @foreach ($subcategories as $subcategory)
                                        <option @selected(old('subcategory_id') === $brand->id) value="{{ $subcategory->id }}">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="details_en" id="details_en" rows="5">{{ old('details-en') }}</textarea>
                        </div>
                        @error('details-en')
                            <div class="alert alert-white text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="details_ar" id="details_ar" rows="5">{{ old('details-ar') }}</textarea>
                        </div>
                        @error('details_ar')
                            <div class="alert alert-white text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <button type="submit" class="btn btn-success mr-1 waves-effect waves-light">Create</button>
